...
//				registry.addMapping("/odontologos/buscarXnombre").allowedOrigins("http://127.0.0.1:5500");
...
//				registry.addMapping("/pacientes/buscar/mail").allowedOrigins("http://127.0.0.1:5500");
